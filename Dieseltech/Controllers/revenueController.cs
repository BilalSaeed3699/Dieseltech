...
namespace Dieseltech.Controllers
{
    public class revenueController : Controller
    {
        ...
        // GET: revenue
        public ActionResult companyrevenue(int ddlAgentvalue=0, int Year = 0, int ddlmonth = 0)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult ReloadCompanyreveneu(int? ddlAgentvalue, int? Year = 0, int? ddlmonth = 0)
        {

            return Json(new { url = Url.Action("companyrevenue", "revenue", new { ddlAgentvalue = ddlAgentvalue, Year= Year, ddlmonth= ddlmonth }) });
        }
    }
}