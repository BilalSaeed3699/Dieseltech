...
namespace Dieseltech.Controllers
{
    ...
    public class revenueController : Controller
    {
        ...
        public ActionResult carrierrevenue(int ddlAgentvalue = 0, int Year = 0, int ddlmonth = 0, int CheckAjax = 0)
        {
            try
            {
                Days Obj = new Days { ID = "1", Day = "Jan" };
                ...
                //ViewBag.AgentList = deEntity.Sp_Get_Agents_List().ToList();
                //ViewBag.UserId = userid;
                List<Sp_Get_Carrier_Revenue_Result> CustomerRevenue = deEntity.Sp_Get_Carrier_Revenue(Query).ToList();
                ViewBag.CustomerRevenue = CustomerRevenue;
        ...
        [HttpPost]
        public ActionResult Reloadcarrierrevenue(int? ddlAgentvalue, int? Year = 0, int? ddlmonth = 0, int CheckAjax = 0)
        {

            return Json(new { url = Url.Action("carrierrevenue", "revenue", new { ddlAgentvalue = ddlAgentvalue, Year = Year, ddlmonth = ddlmonth, CheckAjax = CheckAjax }) });
        }
    }
}