(function ($) {
    ...
    $.fn.colorPalettePicker.defaults = {
        button: '<button name="colorpalettebutton" class="{buttonClass}" data-toggle="dropdown"><span name="{buttonPreviewName}" style="display:none">■ </span> <i style="font-size:20px" class="fa fa-paint-brush"></i>{buttonText}</button>',
        buttonClass: 'btn btn-secondary dropdown-toggle Choose',
        ...
        palette: ['aqua', 'brown', 'cyan', 'darkcyan', 'darkgrey', 'darkkhaki', 'darkorange', 'darkorchid', 'darksalmon', 'fuchsia', 'gold', 'green'],
